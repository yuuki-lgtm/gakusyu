  ...
  const demo = () => ({
    ...
    items: [
      { id: "i1", subject: "数学", unitId: "u1", label: "負の数のかけ算", note: "符号を落とす", fmt: "計算", etype: "分かっていたが間違えた", createdOn: day(-8),
        ...
        diag: null, src: { path: "fam-demo/math/wb/11.jpg", kind: "ワーク", page: 11, x: 0.3, y: 0.42 }, genOn: day(-1), printedOn: day(-1), printedAs: 1, updatedAt: ts(-1) },
    ...
    materials: [
      { id: "m1", subject: "数学", kind: "ワーク", page: 10, path: "fam-demo/math/wb/10.jpg", doneOn: day(-3), idx: { ns: ["1", "2(1)", "2(2)"], at: day(-3) }, updatedAt: ts(-3) },
