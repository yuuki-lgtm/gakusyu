...
const EXPORTS = [
  ...
  // 画面
  "App", "HomeTab", "MorningPrint", "NightFlow", "LastPageStep", "NIGHT_STEPS", "nightLoad", "nightSave", "nightHas", "nightNext", "nightPrev", "TodayTab", "TodayMake", "TodayGrade", "GradeRowDetail", "diagnose", "WeekTab", "MakePapers", "MockMaker", "PaperRow", "PaperGrade", "ReadingMaker", "WritingFlow", "ManualTest",
  "PrintSheet", "RegTab", "UnitReg", "ItemReg", "ItemList", "MaterialReg", "TapReg", "popCls", "tapHit", "marksOn", "tapsToItems", "markDone", "markDoneUpTo", "applyAutoProgress", "untouchedPages", "buildIndex", "openScreen", "MoreTab", "AnaTab", "FormatBlock", "ExamTab", "ExamCard", "ExportTab", "Settings",
];
