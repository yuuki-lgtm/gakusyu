...
const EXPORTS = [
  ...
  // 画面
  "App", "notify", "Snacks", "Hint", "hintSeen", "markHint", "HomeTab", "MorningPrint", "NightFlow", "LastPageStep", "NIGHT_STEPS", "nightLoad", "nightSave", "nightHas", "nightNext", "nightPrev", "TodayTab", "TodayMake", "TodayGrade", "GradeRowDetail", "diagnose", "WeekTab", "MakePapers", "MockMaker", "PaperRow", "PaperGrade", "ReadingMaker", "WritingFlow", "ManualTest",
