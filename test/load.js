...
const EXPORTS = [
  ...
  // 画面
  "App", "notify", "Snacks", "Fab", "Hint", "hintSeen", "markHint", "HomeTab", "MorningPrint", "LastPageStep", "TodayTab", "TodayMake", "TodayGrade", "GradeRowDetail", "diagnose", "WeekTab", "MakePapers", "MockMaker", "PaperRow", "PaperGrade", "ReadingMaker", "WritingFlow", "ManualTest",
