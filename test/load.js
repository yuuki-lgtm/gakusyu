...
const EXPORTS = [
  // 定数
  "VERSION", "KEY", "SUBJECTS", "HUE", "FORMATS", "ETYPES", "INT", "STABLE_LEVEL", "MKINDS", "BOOK_KINDS", "SUBJ_CODE", "KIND_CODE",
  // 日付など
  "today", "addDays", "diffDays", "pct", "blank",
  // 中核ロジック
  "migrate", "mergeData", "needsWhy", "problemCount", "removeRec", "newItem", "unitById", "sbFetch", "cfgLink", "importCfg", "matPath", "nextPageNo", "TEST_ROLES", "roleOf", "answerSheets", "pairSheet", "stUpload", "stGet", "stRemove", "pagesToRanges", "isSpreadShape", "assignPages", "splitSpread", "findGutter", "parsePages", "unitPages", "unitForPage", "applyTOC", "unitPageLabel", "materialsForUnits", "matsLabel", "b64ToBlob", "bufToB64", "matsOf", "applyJudgment", "retention", "streakDays", "pickUnits", "taught", "nextActions", "lastCumOn", "OPUS", "SONNET", "pickModel", "allOpus", "callAI", "genPaper", "upcomingExams", "examSubjects", "mocksFor", "mockRound", "mockDue", "refSheets", "testSheets", "paperTitle", "normalizePts", "flattenSections", "mockPromptFor", "MOCK_SECTIONS", "parseJSON", "apiErrorText", "apiBlock", "setApiBlock", "Banner", "BLOCK_TEXT", "parseItemsLoose", "genContent", "genForItem", "needsCheck", "verifyGen", "needsGuide", "guideFor", "srcLabel", "annotateB64", "hasPos", "markDesc", "nameItems", "nameAndApply", "splitListening", "mergeSameSkill", "stepToItem", "applyGen", "printSet", "paperStatus", "undoSpread", "pickDaily", "dailyMax", "examRangeIds", "gradeSet", "judgeAll", "selfMarksText", "applySelfMarks", "readSelfMarks", "gradeResult", "predictFor", "judgeCarried", "deferForExam", "deferredFor", "ctxFor", "itemContext", "SELF_NOTE",
  // 印刷
  ...
  // 画面
  "App", "notify", "Snacks", "Fab", "pending", "takePending", "isPdfFile", "Hint", "hintSeen", "markHint", "HomeTab", "MorningPrint", "LastPageStep", "PaperTab", "ItemsTab", "MatsTab", "route", "TodayMake", "TodayGrade", "GradeRowDetail", "diagnose", "MakePapers", "MockMaker", "PaperRow", "PaperGrade", "ReadingMaker", "WritingFlow", "ManualTest",
  "PrintSheet", "UnitReg", "ItemReg", "ItemList", "MaterialReg", "TapReg", "MarkPop", "tapHit", "marksOn", "tapsToItems", "markDone", "markDoneUpTo", "applyAutoProgress", "untouchedPages", "buildIndex", "openScreen", "MoreTab", "GuideTab", "AnaTab", "FormatBlock", "ExamTab", "ExamCard", "ExportTab", "Settings",
];
