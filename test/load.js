...
const EXPORTS = [
  ...
  "PrintSheet", "RegTab", "UnitReg", "ItemReg", "ItemList", "MaterialReg", "TapReg", "tapHit", "marksOn", "tapsToItems", "markDone", "markDoneUpTo", "applyAutoProgress", "untouchedPages", "buildIndex", "openScreen", "MoreTab", "AnaTab", "FormatBlock", "ExamTab", "ExamCard", "ExportTab", "Settings",
];
